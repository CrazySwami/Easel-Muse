...
export const ImagePrimitive = ({
  ...
  return (
    <NodeLayout id={id} data={{ ...data, width: data.width ?? 840, height: data.height ?? 560, resizable: false, dualModeSupported: true, titleOverride: 'Image' }} type={type} title={title} toolbar={toolbar}>
